        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<i>❗ Flood Wait Error ❗Shinobu VC Assistant couldn't join your group! Make sure Shinobu VC Assistant is not banned in group."
                        "\n\nOr manually add @ShinobuVCassistant to your Group and try again</i>",
                    )
    try:
        await USER.get_chat(chid)
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<i>❗ Flood Wait Error ❗Shinobuhinobu VC Assistant couldn't join your group! Make sure Shinobu VC Assistant is not banned in group."
                        "\n\nOr manually add @ShinobuVCassistant to your Group and try again</i>",
                    )
    try:
        await USER.get_chat(chid)
...
async def lol_cb(b, cb):
    ...
    if cb.from_user.id != useer_id:
        ...
        return
    await cb.message.edit("Shinobu Is Getting Ready To Play Music, Hang On.....")
    x=int(x)
    try:
